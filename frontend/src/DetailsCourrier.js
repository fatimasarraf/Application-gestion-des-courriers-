...
const DetailsCourrier = () => {
  ...
  useEffect(() => {
    const fetchCourrierDetails = async () => {
      try {
        const response = await fetch(`http://127.0.0.1:8000/api/Courrier/courriers-detail/${id}/`);
        if (!response.ok) {
  ...
  return (
    <div className="courrier-details">
      ...
      <h2 className="dashboard-title">Détails du Courrier Départ</h2>
      ...
      <div className="line">
        ...
        <div className="input-group">
          <label htmlFor="sortie"><strong>Sortie le</strong></label>
      ...
      <div className="line">
        <div className="input-group">
          <label htmlFor="traitePar"><strong>Traité par</strong></label>
          <input type="text" id="traitePar" value={courrierDetails.traitePar} readOnly />
        </div>
        <div className="input-group">
          <label htmlFor="signePar"><strong>Signé par</strong></label>
          <input type="text" id="signePar" value={courrierDetails.signePar} readOnly />
        </div>
      </div>
      <div className="line">
        <div className="input-group">
